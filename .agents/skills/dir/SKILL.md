...
# Skill: /dir (Gobernanza y Ruteo de Arquitectura Thinking)

Esta habilidad proporciona el flujo para consultar, inicializar y clasificar elementos dentro de la estructura **Directorio Thinking** gobernada por [`FWengine.py`](file:///d:/0001%20HyperScale%20Thinking/PROYECTOS%20CLOUD/DeepMind/FrameWork/FWengine.py).
...
```powershell
python "d:\0001 HyperScale Thinking\PROYECTOS CLOUD\DeepMind\FrameWork\FWengine.py" init [ruta]
```
...
```powershell
python "d:\0001 HyperScale Thinking\PROYECTOS CLOUD\DeepMind\FrameWork\FWengine.py" route "<ruta_al_archivo>"
```
...
```powershell
python "d:\0001 HyperScale Thinking\PROYECTOS CLOUD\DeepMind\FrameWork\FWengine.py" route "<ruta_al_archivo>" --move
```
...
1. Cuando el usuario invoque el comando `/dir` o solicite clasificar/mover archivos, ejecuta la acción invocando `FWengine.py` mediante el tool `run_command`.
